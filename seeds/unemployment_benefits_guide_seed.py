#!/usr/bin/env python3
"""Unemployment Benefits Guide 初期記事シードデータ（英語）"""
...
ARTICLES = [
    ...
    },
    {
        ...
        "body": "<h2>What is Eligibility?</h2>\n<p>Eligibility is an important topic for anyone researching unemployment benefits guide. This article provides general information to help you understand the basics as of 2026. Eligibility requirements.</p>\n<h2>Who is this relevant to?</h2>\n<p>This topic is relevant to individuals and families planning their finances, and to those who want accurate, up-to-date information. Requirements and rules can change, so it is wise to verify current details with official sources.</p>\n<h2>How do I get started?</h2>\n<p>The process generally involves understanding your needs, gathering relevant information, and comparing available options. The right approach depends on your individual circumstances and goals.</p>\n<h2>What should I keep in mind?</h2>\n<p>There are several important considerations. Because this involves financial decisions, you should not rely on general information alone. Consult a qualified professional for advice specific to your situation.</p>"
    },
    {
        ...
        "category": "Applying",
        "body": "<h2>What is Applying?</h2>\n<p>Applying is an important topic for anyone researching unemployment benefits guide. This article provides general information to help you understand the basics as of 2026. How to apply.</p>\n<h2>Who is this relevant to?</h2>\n<p>This topic is relevant to individuals and families planning their finances, and to those who want accurate, up-to-date information. Requirements and rules can change, so it is wise to verify current details with official sources.</p>\n<h2>How do I get started?</h2>\n<p>The process generally involves understanding your needs, gathering relevant information, and comparing available options. The right approach depends on your individual circumstances and goals.</p>\n<h2>What should I keep in mind?</h2>\n<p>There are several important considerations. Because this involves financial decisions, you should not rely on general information alone. Consult a qualified professional for advice specific to your situation.</p>"
    },
    {
        ...
        "category": "Amounts",
        "body": "<h2>What is Amounts?</h2>\n<p>Amounts is an important topic for anyone researching unemployment benefits guide. This article provides general information to help you understand the basics as of 2026. Benefit amounts.</p>\n<h2>Who is this relevant to?</h2>\n<p>This topic is relevant to individuals and families planning their finances, and to those who want accurate, up-to-date information. Requirements and rules can change, so it is wise to verify current details with official sources.</p>\n<h2>How do I get started?</h2>\n<p>The process generally involves understanding your needs, gathering relevant information, and comparing available options. The right approach depends on your individual circumstances and goals.</p>\n<h2>What should I keep in mind?</h2>\n<p>There are several important considerations. Because this involves financial decisions, you should not rely on general information alone. Consult a qualified professional for advice specific to your situation.</p>"
    },
    {
        ...
        "category": "Rights",
        "body": "<h2>What is Rights?</h2>\n<p>Rights is an important topic for anyone researching unemployment benefits guide. This article provides general information to help you understand the basics as of 2026. Your rights.</p>\n<h2>Who is this relevant to?</h2>\n<p>This topic is relevant to individuals and families planning their finances, and to those who want accurate, up-to-date information. Requirements and rules can change, so it is wise to verify current details with official sources.</p>\n<h2>How do I get started?</h2>\n<p>The process generally involves understanding your needs, gathering relevant information, and comparing available options. The right approach depends on your individual circumstances and goals.</p>\n<h2>What should I keep in mind?</h2>\n<p>There are several important considerations. Because this involves financial decisions, you should not rely on general information alone. Consult a qualified professional for advice specific to your situation.</p>"
    }
]
