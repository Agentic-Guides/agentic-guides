#!/usr/bin/env python3
"""Credit Card Rewards Guide 初期記事シードデータ（英語）"""
...
ARTICLES = [
    ...
    },
    {
        ...
        "category": "Cashback",
        "body": "<h2>What is Cashback?</h2>\n<p>Cashback is an important topic for anyone researching credit card rewards guide. This article provides general information to help you understand the basics as of 2026. Cashback cards.</p>\n<h2>Who is this relevant to?</h2>\n<p>This topic is relevant to individuals and families planning their finances, and to those who want accurate, up-to-date information. Requirements and rules can change, so it is wise to verify current details with official sources.</p>\n<h2>How do I get started?</h2>\n<p>The process generally involves understanding your needs, gathering relevant information, and comparing available options. The right approach depends on your individual circumstances and goals.</p>\n<h2>What should I keep in mind?</h2>\n<p>There are several important considerations. Because this involves financial decisions, you should not rely on general information alone. Consult a qualified professional for advice specific to your situation.</p>"
    },
    {
        ...
        "category": "Points",
        "body": "<h2>What is Points?</h2>\n<p>Points is an important topic for anyone researching credit card rewards guide. This article provides general information to help you understand the basics as of 2026. Points and miles.</p>\n<h2>Who is this relevant to?</h2>\n<p>This topic is relevant to individuals and families planning their finances, and to those who want accurate, up-to-date information. Requirements and rules can change, so it is wise to verify current details with official sources.</p>\n<h2>How do I get started?</h2>\n<p>The process generally involves understanding your needs, gathering relevant information, and comparing available options. The right approach depends on your individual circumstances and goals.</p>\n<h2>What should I keep in mind?</h2>\n<p>There are several important considerations. Because this involves financial decisions, you should not rely on general information alone. Consult a qualified professional for advice specific to your situation.</p>"
    },
    {
        ...
        "category": "Bonuses",
        "body": "<h2>What is Bonuses?</h2>\n<p>Bonuses is an important topic for anyone researching credit card rewards guide. This article provides general information to help you understand the basics as of 2026. Sign-up bonuses.</p>\n<h2>Who is this relevant to?</h2>\n<p>This topic is relevant to individuals and families planning their finances, and to those who want accurate, up-to-date information. Requirements and rules can change, so it is wise to verify current details with official sources.</p>\n<h2>How do I get started?</h2>\n<p>The process generally involves understanding your needs, gathering relevant information, and comparing available options. The right approach depends on your individual circumstances and goals.</p>\n<h2>What should I keep in mind?</h2>\n<p>There are several important considerations. Because this involves financial decisions, you should not rely on general information alone. Consult a qualified professional for advice specific to your situation.</p>"
    },
    {
        ...
        "category": "Maximizing",
        "body": "<h2>What is Maximizing?</h2>\n<p>Maximizing is an important topic for anyone researching credit card rewards guide. This article provides general information to help you understand the basics as of 2026. Maximizing rewards.</p>\n<h2>Who is this relevant to?</h2>\n<p>This topic is relevant to individuals and families planning their finances, and to those who want accurate, up-to-date information. Requirements and rules can change, so it is wise to verify current details with official sources.</p>\n<h2>How do I get started?</h2>\n<p>The process generally involves understanding your needs, gathering relevant information, and comparing available options. The right approach depends on your individual circumstances and goals.</p>\n<h2>What should I keep in mind?</h2>\n<p>There are several important considerations. Because this involves financial decisions, you should not rely on general information alone. Consult a qualified professional for advice specific to your situation.</p>"
    }
]
