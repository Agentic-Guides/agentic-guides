#!/usr/bin/env python3
"""全50サイトにMarkdown交渉middlewareが入った状態で再デプロイ（Functions bundle確実反映）"""
...
for slug in SITES:
    ...
    # Markdown入りmiddlewareを確実にコピー（grant-navigator以外）
    ...
    if r.returncode == 0:
        ...
        fail += 1
        print(f"FAIL {slug}: {r.stderr[-100:]}")
