...
GENERIC_TOPICS_EN = [
    ...
    "What Changes Took Effect Recently",
    "A Quick Reference for Busy Readers",
    ...
    "The Top Priorities for This Year",
    "What the Fine Print Really Says",
    "A Clear Path From Applying to Receiving",
    ...
    "The Quick Guide to Getting Started Today",
    ...
    "How to Avoid the Most Common Rejections",
